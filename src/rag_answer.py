...
# Load documents
# -----------------------------
docs_path = Path("data/corpus/docs.jsonl")
documents = []
...
for q in questions:
    ...
    # Save in required format: {"q0": "answer", ...}
    answers_dict[question_id] = answer_text

# -----------------------------
# Save submission file
# -----------------------------
submission_path = Path("submissions/rag_answers.json")
submission_path.parent.mkdir(parents=True, exist_ok=True)

with submission_path.open("w") as f:
    json.dump(answers_dict, f, indent=2)

print(f"Saved submission-ready answers to {submission_path}")
